...
nrow(XtslaWithoutSentiments)
nrow(XgoogWithoutSentiments)
#Data Split
##TSLA
...
resultsTestClass_Tsla = data.frame(
  accuracyLogistic = accuracyLinear_TslaSRdummy,#Logistic
...
resultsTestClass_Goog = data.frame(
  accuracyLogistic = accuracyLinear_GoogSRdummy,#Logistic
...
```{r elasticNetTuningParametersSum}
set.seed(2020)
cl = parallel::makeCluster(8)
doParallel::registerDoParallel(cl)
####Supervisor Y1 = YtslaWithSentiments$diffHighLowTomorrow
...
betaHatGlmnetTslaSRdummy_SentiSum = coef(glmnetOutTslaSRdummy_SentiSum, 
                                s = elasticOutTslaSRdummy_SentiSum$bestTune$lambda)
#Accuracy
table(YhatTestSentiSum_TslaSRdummy,Ytest_tslaSRdummy)
(accuracyLinearSentiSum_TslaSRdummy = sum(diag(table(YhatTestSentiSum_TslaSRdummy, Ytest_tslaSRdummy)))/length(Ytest_tslaSRdummy))
...
betaHatGlmnetGoogSRdummy_SentiSum = coef(glmnetOutGoogSRdummy_SentiSum, 
                                s = elasticOutGoogSRdummy_SentiSum$bestTune$lambda)
#Accuracy
(accuracyLinearSentiSum_GoogSRdummy = sum(diag(table(YhatTestSentiSum_GoogSRdummy, Ytest_googSRdummy)))/length(Ytest_googSRdummy))
...
resultsTestClassSentiSum_Tsla = data.frame(
  accuracyLogistic_SentiSum = accuracyLinearSentiSum_TslaSRdummy,#Logistic
  accuracyFDA_SentiSum  = TslaSRdummySentiSum_accuracyFDA,#MARS
...
#GOOG Classification Tree - Y3
YhatTestTreeSentiSum_GoogSRdummyProb = predict(rpartOutSentiSum_GoogSRdummy, XtestSentiSum_googSRdummy,
                                  type = 'prob')
...
resultsTestClassSentiSum_Goog = data.frame(
  accuracyLogistic_SentiSum = accuracyLinearSentiSum_GoogSRdummy,#Logistic
...
colVec = rainbow(8)
par(mar = c(7,5,4,2))
plot(1:ncol(resultsTest_TslaHL), 
     sapply(resultsTest_TslaHL, function(Yhat){mean((Yhat - Ytest_tslaHL)^2)}), 
     col = colVec[1],pch = 15, ylim = c(1.2,3.5), ylab = "TSLA Test Error- Supervisor = diffHighLow", xlab = " " )
points(1:ncol(resultsTestSentiSum_TslaHL),  
       sapply(resultsTestSentiSum_TslaHL, function(Yhat){mean((Yhat - Ytest_tslaHL)^2)}),  
       col = colVec[2], pch = 16)
points(1:ncol(resultsTestSentiMean_TslaHL),  
       sapply(resultsTestSentiMean_TslaHL, function(Yhat){mean((Yhat - Ytest_tslaHL)^2)}),  
       col = colVec[3], pch = 17)
axis(1, labels = names(resultsTest_TslaHL), at = 1:ncol(resultsTest_TslaHL), 
     las = 3)
legend('topright', col = colVec, pch = c(15:21), 
       legend = c('without Sentiments','with Sentiments(Sum)','with Sentiments(Mean)'))

par(mar = c(7,5,4,2))
plot(1:ncol(resultsTest_TslaSR), 
     sapply(resultsTest_TslaSR, function(Yhat){mean((Yhat - Ytest_tslaSR)^2)}), 
     col = colVec[1],pch = 15, ylim = c(1.2,1.35), ylab = "TSLA Test Error - Supervisor = stock return", xlab = " " )
points(1:ncol(resultsTestSentiSum_TslaSR),  
       sapply(resultsTestSentiSum_TslaSR, function(Yhat){mean((Yhat - Ytest_tslaSR)^2)}),  
       col = colVec[2], pch = 16)
points(1:ncol(resultsTestSentiMean_TslaSR),  
       sapply(resultsTestSentiMean_TslaSR, function(Yhat){mean((Yhat - Ytest_tslaSR)^2)}),  
       col = colVec[3], pch = 17)
axis(1, labels = names(resultsTest_TslaSR), at = 1:ncol(resultsTest_TslaSR), 
     las = 3)
#legend('topright', col = colVec, pch = c(15:21), 
#       legend = c('without Sentiments','with Sentiments(Sum)','with Sentiments(Mean)'))
...
par(mar = c(7,5,4,2))
plot(1:ncol(resultsTest_GoogHL), 
     sapply(resultsTest_GoogHL, function(Yhat){mean((Yhat - Ytest_googHL)^2)}), 
     col = colVec[1],pch = 15, ylim = c(0.8,1.15), 
     ylab = "GOOG Test Error- Supervisor = diffHighLow", xlab = " " )
points(1:ncol(resultsTestSentiSum_GoogHL),  
       sapply(resultsTestSentiSum_GoogHL, function(Yhat){mean((Yhat - Ytest_googHL)^2)}),  
       col = colVec[2], pch = 16)
points(1:ncol(resultsTestSentiMean_GoogHL),  
       sapply(resultsTestSentiMean_GoogHL, function(Yhat){mean((Yhat - Ytest_googHL)^2)}),  
       col = colVec[3], pch = 17)
axis(1, labels = names(resultsTest_GoogHL), at = 1:ncol(resultsTest_GoogHL), 
     las = 3)
#legend('topright', col = colVec, pch = c(15:21), 
#       legend = c('without Sentiments','with Sentiments(Sum)','with Sentiments(Mean)'))

par(mar = c(7,5,4,2))
plot(1:ncol(resultsTest_GoogSR), 
     sapply(resultsTest_GoogSR, function(Yhat){mean((Yhat - Ytest_googSR)^2)}), 
     col = colVec[1],pch = 15, ylim = c(0.5,1.7), 
     ylab = "GOOG Test Error - Supervisor = stock return", xlab = " " )
points(1:ncol(resultsTestSentiSum_GoogSR),  
       sapply(resultsTestSentiSum_GoogSR, function(Yhat){mean((Yhat - Ytest_googSR)^2)}),  
       col = colVec[2], pch = 16)
points(1:ncol(resultsTestSentiMean_GoogSR),  
       sapply(resultsTestSentiMean_GoogSR, function(Yhat){mean((Yhat - Ytest_googSR)^2)}),  
       col = colVec[3], pch = 17)
axis(1, labels = names(resultsTest_GoogSR), at = 1:ncol(resultsTest_GoogSR), 
     las = 3)
legend('topright', col = colVec, pch = c(15:21), 
       legend = c('without Sentiments','with Sentiments(Sum)','with Sentiments(Mean)'))
...
par(mar = c(7,5,4,2))
plot(1:ncol(resultsTestClass_Tsla), resultsTestClass_Tsla, col = colVec[1], 
     pch = 15, ylim = c(0,0.6), ylab = "TSLA Accuracy- Supervisor = stock return (dummy)", xlab = " " )
points(1:ncol(resultsTestClassSentiSum_Tsla),  resultsTestClassSentiSum_Tsla,  col = colVec[2], pch = 16)
points(1:ncol(resultsTestClassSentiMean_Tsla),  resultsTestClassSentiMean_Tsla,  col = colVec[3], pch = 17)
axis(1, labels = names(resultsTestClass_Tsla), at = 1:ncol(resultsTestClass_Tsla), 
     las = 3)
#legend('topright', col = colVec, pch = c(15:21), 
#       legend = c('without Sentiments','with Sentiments(Sum)','with Sentiments(Mean)'))
...
par(mar = c(7,5,4,2))
plot(1:ncol(resultsTestClass_Goog), resultsTestClass_Goog, col = colVec[1], 
     pch = 15, ylim = c(0,1), ylab = "GOOG Accuracy- Supervisor = stock return (dummy)", xlab = " " )
points(1:ncol(resultsTestClassSentiSum_Goog),  resultsTestClassSentiSum_Goog,  col = colVec[2], pch = 16)
points(1:ncol(resultsTestClassSentiMean_Goog),  resultsTestClassSentiMean_Goog,  col = colVec[3], pch = 17)
...
betaHatGlmnetTslaSRdummy_SentiMean = coef(glmnetOutTslaSRdummy_SentiMean, 
                                s = elasticOutTslaSRdummy_SentiMean$bestTune$lambda)
#Accuracy
table(YhatTestSentiMean_TslaSRdummy,Ytest_tslaSRdummy)
(accuracyLinearSentiMean_TslaSRdummy = sum(diag(table(YhatTestSentiMean_TslaSRdummy, Ytest_tslaSRdummy)))/length(Ytest_tslaSRdummy))
...
betaHatGlmnetGoogSRdummy_SentiMean = coef(glmnetOutGoogSRdummy_SentiMean, 
                                s = elasticOutGoogSRdummy_SentiMean$bestTune$lambda)
#Accuracy
(accuracyLinearSentiMean_GoogSRdummy = sum(diag(table(YhatTestSentiMean_GoogSRdummy, Ytest_googSRdummy)))/length(Ytest_googSRdummy))
...
(TslaSRdummySentiMean_accuracyFDA = sum(diag(table(YhatTestFDASentiMean_TslaSRdummy, Ytest_tslaSRdummy)))/length(Ytest_tslaSRdummy))
...
(TslaSRdummySentiMean_accuracyTree = sum(diag(table(YhatTestTreeSentiMean_TslaSRdummy, Ytest_tslaSRdummy)))/length(Ytest_tslaSRdummy))
...
(TslaSRdummySentiMean_accuracyRF = sum(diag(table(YhatTestRFSentiMean_TslaSRdummy, Ytest_tslaSRdummy)))/length(Ytest_tslaSRdummy))
...
(TslaSRdummySentiMean_accuracyBoost = sum(diag(table(YhatTestBoostSentiMean_TslaSRdummy, Ytest_tslaSRdummy)))/length(Ytest_tslaSRdummy))

#Summary - TSLA - Classification
resultsTestClassSentiMean_Tsla = data.frame(
  accuracyLogistic_SentiSum = accuracyLinearSentiMean_TslaSRdummy,#Logistic
...
(GoogSRdummySentiMean_accuracyFDA = sum(diag(table(YhatTestFDASentiMean_GoogSRdummy, Ytest_googSRdummy)))/length(Ytest_googSRdummy))

#GOOG Classification Tree - Y3
YhatTestTreeSentiMean_GoogSRdummyProb = predict(rpartOutSentiMean_GoogSRdummy, XtestSentiMean_googSRdummy,
                                  type = 'prob')
...
(GoogSRdummySentiMean_accuracyTree = sum(diag(table(YhatTestTreeSentiMean_GoogSRdummy, Ytest_googSRdummy)))/length(Ytest_googSRdummy))
...
(GoogSRdummySentiMean_accuracyRF = sum(diag(table(YhatTestRFSentiMean_GoogSRdummy, Ytest_googSRdummy)))/length(Ytest_googSRdummy))
...
(GoogSRdummySentiMean_accuracyBoost = sum(diag(table(YhatTestBoostSentiMean_GoogSRdummy, Ytest_googSRdummy)))/length(Ytest_googSRdummy))


#Summary - GOOG - Classification
resultsTestClassSentiMean_Goog = data.frame(
  accuracyLogistic_SentiSum = accuracyLinearSentiMean_GoogSRdummy,#Logistic
