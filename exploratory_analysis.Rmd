...
betaHatGlmnetTslaSRdummy = coef(glmnetOutTslaSRdummy, 
                                s = elasticOutTslaSRdummy$bestTune$lambda)
#Accuracy
mean(YhatTest_TslaSRdummy==Ytest_tslaSRdummy)
...
betaHatGlmnetGoogSRdummy = coef(glmnetOutGoogSRdummy, 
                                s = elasticOutGoogSRdummy$bestTune$lambda)
#Accuracy
mean(YhatTest_GoogSRdummy==Ytest_googSRdummy)
...
#trControl = caret::trainControl(method = "repeatedcv", repeats = 2, 
                               # number = 10, classProbs = TRUE)
#Y1
tuneGridTree_GoogHL = expand.grid(cp = c(0.0001,0.001,0.01,0.1,0.15,0.5,1))
...
#Y2
tuneGridTree_GoogSR = expand.grid(cp = c(0.0001,0.001,0.01,0.1,0.15,0.5,1))
...
####GOOG
(boostImportance_GoogHL0 = xgboost::xgb.importance(model = boostOutRandom_GoogHL$finalModel))

(boostImportance_GoogSR0 = xgboost::xgb.importance(model = boostOutRandom_GoogSR$finalModel))

(boostImportance_GoogSRdummy0 = xgboost::xgb.importance(model = boostOutRandom_GoogSRdummy$finalModel))
```
...
resultsTest_TslaHL  = data.frame(
  TslaHL_YhatGlmnet = c(predict(glmnetOutTslaHL, XtestMat_tslaHL,
                         s = elasticOutTslaHL$bestTune$lambda)),
  TslaHL_YhatMARS   = c(predict(marsOutTslaHL, XtestMat_tslaHL)),
  TslaHL_YhatTrees  = predict(rpartOut_TslaHL, XtestMat_tslaHL),
  TslaHL_YhatRF     = predict(rfOut_tslaHL, XtestMat_tslaHL),
  TslaHL_YhatBoost  = predict(boostOutRandom_TslaHL, XtestMat_tslaHL)
)
...
resultsTest_TslaSR  = data.frame(
  TslaSR_YhatGlmnet = c(predict(glmnetOutTslaSR, XtestMat_tslaSR,
                         s = elasticOutTslaSR$bestTune$lambda)),
  TslaSR_YhatMARS   = c(predict(marsOutTslaSR, XtestMat_tslaSR)),
  TslaSR_YhatTrees  = predict(rpartOut_TslaSR, XtestMat_tslaSR),
  TslaSR_YhatRF     = predict(rfOut_tslaSR, XtestMat_tslaSR),
  TslaSR_YhatBoost  = predict(boostOutRandom_TslaSR, XtestMat_tslaSR)
)
...
resultsTest_GoogHL  = data.frame(
  GoogHL_YhatGlmnet = c(predict(glmnetOutGoogHL, XtestMat_googHL,
                         s = elasticOutGoogHL$bestTune$lambda)),
  GoogHL_YhatMARS   = c(predict(marsOutGoogHL, XtestMat_googHL)),
  GoogHL_YhatTrees  = predict(rpartOut_GoogHL, XtestMat_googHL),
  GoogHL_YhatRF     = predict(rfOut_googHL, XtestMat_googHL),
  GoogHL_YhatBoost  = predict(boostOutRandom_GoogHL, XtestMat_googHL)
)
...
resultsTest_GoogSR  = data.frame(
  GoogSR_YhatGlmnet = c(predict(glmnetOutGoogSR, XtestMat_googSR,
                         s = elasticOutGoogSR$bestTune$lambda)),
  GoogSR_YhatMARS   = c(predict(marsOutGoogSR, XtestMat_googSR)),
  GoogSR_YhatTrees  = predict(rpartOut_GoogSR, XtestMat_googSR),
  GoogSR_YhatRF     = predict(rfOut_googSR, XtestMat_googSR),
  GoogSR_YhatBoost  = predict(boostOutRandom_GoogSR, XtestMat_googSR)
)
...
resultsTestClass_Tsla = data.frame(
  TslaSRdummy_accuracyFDA,
  TslaSRdummy_accuracyTree,
  TslaSRdummy_accuracyRF,
  TslaSRdummy_accuracyBoost
)
...
resultsTestClass_Goog = data.frame(
  GoogSRdummy_accuracyFDA,
  GoogSRdummy_accuracyTree,
  GoogSRdummy_accuracyRF,
  GoogSRdummy_accuracyBoost
)
