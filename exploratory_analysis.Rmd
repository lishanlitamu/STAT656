...
pastVol_upper = varPastVolumesF(tslaAddVolTemp$PX_VOLUME,5) 
#pastVol_upper[1:20]
...
names(tslaAddVolTemp3)
#Add interaction terms
tslaAddVolTemp3 = tslaAddVolTemp2 %>% 
  mutate(increaseTrend = diffLastOpen * increasedVolume) %>%
  mutate(strongIncreaseTrend = diffLastOpen * largerThanUpperVol) %>%
  select(- c(pastVolume1,pastLastPrice1,diffVolume,increasedVolume,pastVol_upper,largerThanUpperVol))
