...
#Transform the selected data
(tslaRegTrans = caret::preProcess(tslaReg, method = c("BoxCox","center","scale","pca")))

#Apply the transformations("BoxCox","center","scale","pca")
tslaRegPCA = stats::predict(tslaRegTrans,tslaReg) #Outputs are PCA components
utils::head(tslaRegPCA)

#Summary of PCA results
tslaRegTrans_     = caret::preProcess(tslaReg, method = c("BoxCox","center","scale"))
propVarTslaRegPCA = tslaReg %>%
